...
from molar.config import Config
from molar.utils import set_seed
    ...
    def train(self):
        ...
        for epoch in range(config.num_train_epochs):
            for step, pos_batch in enumerate(self.pos_train_dataloader):
                ...
                input_ids = torch.cat((pos_input_ids, neg_input_ids, ood_input_ids), 0)     # input ids
                ...
                labels = torch.cat((pos_labels, neg_labels, ood_labels), 0)     # answer label
